...
)
{
    ...
    #pragma HLS INTERFACE m_axi depth=1 port=resnet_layer1_input_fm bundle=fm
    #pragma HLS INTERFACE m_axi depth=1 port=resnet_layer1_0_conv1_weights bundle=wt
    #pragma HLS INTERFACE m_axi depth=1 port=resnet_layer1_0_bn1_params bundle=wt
    #pragma HLS INTERFACE m_axi depth=1 port=resnet_layer1_0_conv2_weights bundle=wt
    #pragma HLS INTERFACE m_axi depth=1 prot=resnet_layer1_0_bn2_params bundle=wt
    #pragma HLS INTERFACE m_axi depth=1 port=resnet_layer1_0_conv3_weights bundle=wt
    #pragma HLS INTERFACE m_axi depth=1 port=resnet_layer1_0_bn3_params bundle=wt
    #pragma HLS INTERFACE m_axi depth=1 port=resnet_layer1_0_downsample_0_weights bundle=wt
    #pragma HLS INTERFACE m_axi depth=1 port=resnet_layer1_0_downsample_1_params bundle=wt


    
    // Use HLS pragma to control memory access
    #pragma HLS array_partition variable=resnet_layer1_input_fm complete dim=1
    #pragma HLS array_partition variable=resnet_layer1_0_conv1_weights complete dim=1
    #pragma HLS array_partition variable=resnet_layer1_0_bn1_params complete
    #pragma HLS array_partition variable=resnet_layer1_0_conv2_weights complete dim=1
    #pragma HLS array_partition variable=resnet_layer1_0_bn2_params complete
    #pragma HLS array_partition variable=resnet_layer1_0_conv3_weights complete dim=1
    #pragma HLS array_partition variable=resnet_layer1_0_downsample_0_weights complete dim=1
    #pragma HLS array_partition variable=resnet_layer1_0_downsample_1_params complete
