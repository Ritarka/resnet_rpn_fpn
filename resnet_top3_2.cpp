...
#include "qdtrack_resnet3_2.h"

#include "resnet_layers3_2.cpp"
...
)
{
    ...
    // Layer 3
    //----------------------------------------------------------------------
    std::cout << "Begin processing Layer 3_2..." << std::endl;
    ...
    std::cout << "Layer 3_2 Processing Complete!" << std::endl << std::endl;
}
