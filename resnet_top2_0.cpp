...
)
{
    ...
    // Layer 2
    //----------------------------------------------------------------------
    std::cout << "Begin processing Layer 2_0..." << std::endl;
    
    resnet_layer2_0( resnet_layer2_input_fm,
    ...
    std::cout << "Layer 2_0 Processing Complete!" << std::endl << std::endl; 
