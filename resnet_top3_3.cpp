...
#include "qdtrack_resnet3_3.h"

#include "resnet_layers3_3.cpp"
...
{ 
    ...
    // Layer 3
    //----------------------------------------------------------------------
    std::cout << "Begin processing Layer3_3..." << std::endl;
    ...
    std::cout << "Layer 3_3 Processing Complete!" << std::endl << std::endl;
