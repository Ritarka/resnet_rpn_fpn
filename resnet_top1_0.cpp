...
{   
    ...
    // Layer 1
    //----------------------------------------------------------------------
    std::cout << "Begin processing Layer 1_0..." << std::endl;
    
    resnet_layer1_0( resnet_layer1_input_fm,
    ...
    std::cout << "Layer 1_0 Processing Complete!" << std::endl << std::endl;
