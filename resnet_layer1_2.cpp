...
)
{
    ...
    #pragma HLS INTERFACE m_axi depth=1 port=resnet_layer1_output_fm bundle=fm
    #pragma HLS INTERFACE m_axi depth=1 port=resnet_layer1_2_conv1_weights bundle=wt
    #pragma HLS INTERFACE m_axi depth=1 port=resnet_layer1_2_bn1_params bundle=wt
    #pragma HLS INTERFACE m_axi depth=1 port=resnet_layer1_2_conv2_weights bundle=wt
    #pragma HLS INTERFACE m_axi depth=1 prot=resnet_layer1_2_bn2_params bundle=wt
    #pragma HLS INTERFACE m_axi depth=1 port=resnet_layer1_2_conv3_weights bundle=wt
    #pragma HLS INTERFACE m_axi depth=1 port=resnet_layer1_2_bn3_params bundle=wt


    
    // Use HLS pragma to control memory access
    #pragma HLS array_partition variable=resnet_layer1_output_fm complete dim=1
    #pragma HLS array_partition variable=resnet_layer1_2_conv1_weights complete dim=1
    #pragma HLS array_partition variable=resnet_layer1_2_bn1_params complete
    #pragma HLS array_partition variable=resnet_layer1_2_conv2_weights complete dim=1
    #pragma HLS array_partition variable=resnet_layer1_2_bn2_params complete
    #pragma HLS array_partition variable=resnet_layer1_2_conv3_weights complete dim=1
    #pragma HLS array_partition variable=resnet_layer1_2_bn3_params complete
